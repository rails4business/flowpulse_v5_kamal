...
class Admin::BrandsControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @professional = Node.create!(role_assignment: role, title: "MarkPostura", slug: "admin-markpostura", professional: true, status: "published")
    @brand = Node.create!(role_assignment: role, parent: @professional, professional_owner_node: @professional, title: "PosturaCorretta", node_type: "brand", status: "published")
